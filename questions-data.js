    ...
    "items": [
      {
        ...
        "answer": {
          "verdict": "التصحيح",
          "correction": "الخطأ 1: `#include <iostream.h>` ← الصحيح: `#include <iostream>`\n\nالخطأ 2: `main()` ← الصحيح: `int main()`\n\nالخطأ 3: `char x, y;` ← الصحيح: `int x, y;`\n\nالخطأ 4: `cin << \"Sum=\" << x+y << \"\\n\"` ← نستخدم `cout` ونضيف الفاصلة المنقوطة.\n\nالخطأ 5: `x / y` ← الصحيح لحساب باقي القسمة: `x % y`.\n\nالبرنامج المصحح:\n\n```cpp\n#include <iostream>\nusing namespace std;\n\nint main()\n{\n    int x, y;\n\n    cin >> x >> y;\n\n    cout << \"Sum = \" << x + y << endl;\n    cout << \"Mod = \" << x % y << endl;\n\n    return 0;\n}\n```"
        }
      },
      {
        "id": "debug-code-2",
        ...
        "answer": {
          "verdict": "التصحيح",
          "correction": "الخطأ 1: `#include <iostream.h>` ← الصحيح: `#include <iostream>`\n\nالخطأ 2: `main()` ← الصحيح: `int main()`\n\nالخطأ 3: `bool sum = 0;` ← الصحيح: `int sum = 0, i;`\n\nالخطأ 4: `for (int i = 1; i <= 15; i--)` ← المجال الصحيح من `15` إلى `25` والزيادة تكون `i++`.\n\nالخطأ 5: `if (i / 2 = 0);` ← الصحيح: `if (i % 2 == 0)` دون فاصلة منقوطة.\n\nالخطأ 6: `sum = sum + 1;` ← الصحيح لجمع الأعداد: `sum = sum + i;`\n\nالخطأ 7: `cin << \"sum is : \" << i;` ← الصحيح: `cout << \"sum is : \" << sum;`.\n\nالبرنامج المصحح:\n\n```cpp\n#include <iostream>\nusing namespace std;\n\nint main()\n{\n    int sum = 0, i;\n\n    for (i = 15; i <= 25; i++)\n    {\n        if (i % 2 == 0)\n            sum = sum + i;\n    }\n\n    cout << \"sum is : \" << sum;\n\n    return 0;\n}\n```"
        }
      },
      {
        "id": "debug-code-3",
        ...
        "answer": {
          "verdict": "التصحيح",
          "correction": "الخطأ 1: `#include <math.h>` ← البرنامج يحتاج مكتبة الإدخال والإخراج: `#include <iostream>`.\n\nالخطأ 2: `main()` ← الصحيح: `int main()`\n\nالخطأ 3: `int sum = 1;` ← الصحيح: `int sum = 0, i;`\n\nالخطأ 4: `i <= 10` ← الصحيح للمجال المطلوب: `i <= 30`.\n\nالخطأ 5: `if (i / 2 == 0)` ← الصحيح: `if (i % 2 == 0)`.\n\nالخطأ 6: `sum = sum + 1;` ← الصحيح: `sum = sum + i;`\n\nالخطأ 7: طباعة `i` ← الصحيح طباعة `sum`.\n\nالبرنامج المصحح:\n\n```cpp\n#include <iostream>\nusing namespace std;\n\nint main()\n{\n    int sum = 0, i;\n\n    for (i = 1; i <= 30; i++)\n    {\n        if (i % 2 == 0)\n            sum = sum + i;\n    }\n\n    cout << \"sum is : \" << sum;\n\n    return 0;\n}\n```"
        }
      },
      {
        "id": "debug-code-4",
      ...
      },
      {
        ...
        "answer": {
          "verdict": "التصحيح",
          "correction": "الخطأ 1: `#include <iostream.h>` ← الصحيح: `#include <iostream>`\n\nالخطأ 2: `main()` ← الصحيح: `int main()`\n\nالخطأ 3: `bool r;` ← الصحيح: `float r;`\n\nالخطأ 4: `double s, m;` و`double p` ← نستخدم `float`.\n\nالخطأ 5: `cin >> \"m = \" >> m >> \"\\n\";` ← الصحيح للطباعة: `cout << \"m = \" << m << endl;`.\n\nالبرنامج المصحح:\n\n```cpp\n#include <iostream>\nusing namespace std;\n\nint main()\n{\n    float r, s, m, p = 3.14;\n\n    cin >> r;\n\n    m = 2 * p * r;\n    s = p * r * r;\n\n    cout << \"m = \" << m << endl;\n    cout << \"s = \" << s << endl;\n\n    return 0;\n}\n```"
        }
      },
      {
        "id": "debug-code-6",
        ...
        "answer": {
          "verdict": "التصحيح",
          "correction": "الخطأ 1: `#include <iostream.h>` ← الصحيح: `#include <iostream>`\n\nالخطأ 2: `main()` ← الصحيح: `int main()`\n\nالخطأ 3: `char sum = 0;` ← الصحيح: `int sum = 0, i = 30;`\n\nالخطأ 4: `while (i = 1; i++; i <= 20)` ← `while` يحتوي شرطًا واحدًا فقط: `while (i <= 50)`.\n\nالخطأ 5: `sum == sum + 0;` ← الصحيح: `sum = sum + i;` ثم زيادة `i`.\n\nالخطأ 6: `cin << \"sum is\" << i;` ← الصحيح: `cout << \"sum is \" << sum;`.\n\nالبرنامج المصحح:\n\n```cpp\n#include <iostream>\nusing namespace std;\n\nint main()\n{\n    int sum = 0, i = 30;\n\n    while (i <= 50)\n    {\n        sum = sum + i;\n        i++;\n    }\n\n    cout << \"sum is \" << sum;\n\n    return 0;\n}\n```"
        }
      },
      {
        "id": "debug-code-7",
      ...
      },
      {
        ...
        "answer": {
          "verdict": "التصحيح",
          "correction": "الخطأ 1: `#include <iostream.h>` ← الصحيح: `#include <iostream>`\n\nالخطأ 2: `main()` ← الصحيح: `int main()`\n\nالخطأ 3: `char sum = 0;` ← الصحيح: `int sum = 0, i;`\n\nالخطأ 4: المتحول `i` غير مصرح عنه، ويجب أن تبدأ الحلقة من `0` وتنتهي عند `30` مع `i++`.\n\nالخطأ 5: `if (i / 2 = 0)` ← الصحيح: `if (i % 2 == 0)`.\n\nالخطأ 6: `sum = sum + 1;` ← الصحيح: `sum = sum + i;`\n\nالخطأ 7: `cin << \"sum is : \" << i;` ← الصحيح: `cout << \"sum is : \" << sum;`.\n\nالبرنامج المصحح:\n\n```cpp\n#include <iostream>\nusing namespace std;\n\nint main()\n{\n    int sum = 0, i;\n\n    for (i = 0; i <= 30; i++)\n    {\n        if (i % 2 == 0)\n            sum = sum + i;\n    }\n\n    cout << \"sum is : \" << sum;\n\n    return 0;\n}\n```"
        }
      },
      {
        "id": "debug-code-10",
        ...
        "answer": {
          "verdict": "التصحيح",
          "correction": "الخطأ 1: `#include <iostream.h>` ← الصحيح: `#include <iostream>`\n\nالخطأ 2: `main()` ← الصحيح: `int main()`\n\nالخطأ 3: `int sum = 1;` ← الصحيح: `int sum = 0, i;` مع التصريح عن `avg`.\n\nالخطأ 4: `i--` ← الصحيح: `i++`.\n\nالخطأ 5: `sum = sum + 1;` ← الصحيح: `sum = sum + i;`\n\nالخطأ 6: ينقص حساب المتوسط: `avg = sum / 10.0;`.\n\nالخطأ 7: طباعة `i` ← الصحيح طباعة `avg`.\n\nالبرنامج المصحح:\n\n```cpp\n#include <iostream>\nusing namespace std;\n\nint main()\n{\n    int sum = 0, i;\n    float avg;\n\n    for (i = 1; i <= 10; i++)\n    {\n        sum = sum + i;\n    }\n\n    avg = sum / 10.0;\n\n    cout << \"avg = \" << avg;\n\n    return 0;\n}\n```"
        }
      },
      {
        "id": "debug-code-11",
        ...
        "answer": {
          "verdict": "التصحيح",
          "correction": "الخطأ 1: `#include <iostream.h>` ← الصحيح: `#include <iostream>`\n\nالخطأ 2: `main()` ← الصحيح: `int main()`\n\nالخطأ 3: `bool r;` ← الصحيح: `float r;` مع التصريح عن القطر والمحيط والمساحة.\n\nالخطأ 4: ينقص الفاصل المنقوط بعد `cin >> r`.\n\nالخطأ 5: `cin << r * 2` ← الصحيح للطباعة: `cout << diameter`.\n\nالخطأ 6: استخدام `R` خطأ لأن اللغة حساسة لحالة الأحرف؛ الصحيح `r`.\n\nالبرنامج المصحح:\n\n```cpp\n#include <iostream>\nusing namespace std;\n\nint main()\n{\n    float r, p = 3.14, diameter, circumference, area;\n\n    cin >> r;\n\n    diameter = r * 2;\n    circumference = 2 * p * r;\n    area = p * r * r;\n\n    cout << diameter << endl;\n    cout << circumference << endl;\n    cout << area << endl;\n\n    return 0;\n}\n```"
        }
      }
    ]
  },
  {
    ...
    "items": [
      ...
      },
      {
        ...
        "answer": {
          "verdict": "الحل",
          "correction": "```cpp\n#include <iostream>\nusing namespace std;\n\nint main()\n{\n    float price1, price2, price3, sum, average;\n\n    cin >> price1 >> price2 >> price3;\n\n    sum = price1 + price2 + price3;\n    average = sum / 3;\n\n    cout << \"Sum = \" << sum << endl;\n    cout << \"Average = \" << average << endl;\n\n    return 0;\n}\n```"
        }
      },
      {
        "id": "write-program-5",
