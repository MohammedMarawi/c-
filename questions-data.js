  ...
  },
  {
    ...
    "items": [
      ...
      },
      {
        ...
        "answer": {
          "verdict": "التصحيح",
          "correction": "الخطأ 1: `char sum = 0;` ← الصحيح: `int sum = 0;`\n\nالخطأ 2: `while (i = 1; i++; i <= 20)` ← الصحيح: `for (int i = 30; i <= 50; i++)`.\n\nالخطأ 3: `sum == sum + 0;` ← الصحيح: `sum = sum + i;`\n\nالخطأ 4: `cin << \"sum is\" << i;` ← الصحيح: `cout << \"sum is \" << sum;`.\n\nالبرنامج المصحح:\n\n```cpp\n#include <iostream.h>\n\nmain()\n{\n    [[fix]]int[[/fix]] sum = 0;\n\n    [[fix]]for (int i = 30; i <= 50; i++)[[/fix]]\n    {\n        sum [[fix]]=[[/fix]] sum + [[fix]]i[[/fix]];\n    }\n\n    [[fix]]cout[[/fix]] << \"sum is \" << [[fix]]sum[[/fix]];\n\n    return 0;\n}\n```"
        }
      },
      {
        "id": "debug-code-6",
    ...
    "items": [
      {
        "id": "flowchart-1",
        "number": 1,
        "body": "اكتب الخوارزمية البيانية اللازمة لإدخال عدد صحيح `y` وطباعة العبارة `Positive` إذا كان موجبًا والعبارة `Negative` إذا كان سالبًا.",
        "answer": {
          "verdict": "الحل",
          "flowchart": {
            "type": "decision",
      ...
      },
      {
        "id": "flowchart-2",
        "number": 2,
        "body": "اكتب الخوارزمية البيانية اللازمة لحساب ناتج:\r\n\r\n```cpp\r\ny = x / (x - 3)\r\n```",
        "answer": {
          "verdict": "الحل",
          "flowchart": {
      ...
      },
      {
        "id": "flowchart-3",
        "number": 3,
        "body": "اكتب الخوارزمية البيانية اللازمة لإدخال عدد صحيح `y`، ثم طباعة ناتج العملية:\r\n\r\n```cpp\r\n1 / (y - 7)\r\n```",
        "answer": {
          "verdict": "الحل",
          "flowchart": {
            "type": "decision",
